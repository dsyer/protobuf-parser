...
public class ProtobufDescriptorVisitor extends ProtobufBaseVisitor<FileDescriptorProto> {
	...
	public ProtobufDescriptorVisitor(Builder builder, Set<String> enumNames) {
